...
public class Panel extends javax.swing.JPanel {
    ...
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        ...
        animator.addTarget(new PropertySetter(ball, "size", ball.getSize(), new Dimension(100, 100), ball.getSize()));
        animator.addTarget(new PropertySetter(ball, "color", ball.getColor(), new Color(17, 165, 75), new Color(15808724), ball.getColor()));
